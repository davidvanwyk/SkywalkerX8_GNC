...
sys = 'SkywalkerX8_Lateral_Control';
...
SkywalkerX8.Control.Lateral.PhiController.KpPhi = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.PhiController.KiPhi = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.PhiController.KdPhi = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.PhiController.NPhi = zeros(nVa, 1);

SkywalkerX8.Control.Lateral.PhiController.KpPhi2DOF = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.PhiController.KdPhi2DOF = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.PhiController.NPhi2DOF = zeros(nVa, 1);

SkywalkerX8.Control.Lateral.ChiController.KpChi = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.ChiController.KiChi = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.ChiController.KdChi = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.ChiController.NChi = zeros(nVa, 1);

SkywalkerX8.Control.Lateral.ChiController.KpChi2DOF = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.ChiController.KdChi2DOF = zeros(nVa, 1);
SkywalkerX8.Control.Lateral.ChiController.NChi2DOF = zeros(nVa, 1);

SkywalkerX8.Control.Lateral.PhiController.upperSaturationDa = Inf;
SkywalkerX8.Control.Lateral.PhiController.lowerSaturationDa = -Inf;

SkywalkerX8.Control.Lateral.ChiController.upperSaturationPhiC = Inf;
SkywalkerX8.Control.Lateral.ChiController.lowerSaturationPhiC = -Inf;
...
POI = {'SkywalkerX8_Lateral_Control/Phi_c'
       'SkywalkerX8_Lateral_Control/Phi_e' 
       'SkywalkerX8_Lateral_Control/da'
       'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Sum/da*_e'
       'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Product1/Nda*_e'
       'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Integrator/da*'
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Va' 
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/p' 
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Phi'
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Chi'};

ST0.addPoint(POI);

ST0.addOpening('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Phi_c');
ST0.addOpening('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Va');
ST0.addOpening('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Chi');
...
SkywalkerX8.Control.Lateral.PhiController.upperSaturationDa = daMax;
SkywalkerX8.Control.Lateral.PhiController.lowerSaturationDa = -daMax;
...
PhiDaPGainLimitInput = 'SkywalkerX8_Lateral_Control/Sum/Phi_e';
PhiDaPGainLimitOutput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/da';
...
NGainLimitInput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Sum/da*_e';
NGainLimitOutput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Product1/Nda*_e';

NGainLimitLoopOpening = {'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Sum/da*_e',...
                         'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Phi/DF Controller Phi/Product1/Nda*_e'};
...
R3 = TuningGoal.Margins('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Phi', gainMargin, phaseMargin);
R3.Focus = [1E-02 1E02];
...
SkywalkerX8.Control.Lateral.PhiController.KpPhiTF = tableValues.PIDF_Controller_Phi_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.PhiController.KiPhiTF = tableValues.PIDF_Controller_Phi_Ki_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.PhiController.KdPhiTF = tableValues.PIDF_Controller_Phi_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.PhiController.NPhiTF = tableValues.PIDF_Controller_Phi_N_2D_Lookup_Table;

SkywalkerX8.Control.Lateral.PhiController.KpPhi2DOFTF = tableValues.PDF_Controller_Phi_2DOF_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.PhiController.KdPhi2DOFTF = tableValues.PDF_Controller_Phi_2DOF_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.PhiController.NPhi2DOFTF = tableValues.PDF_Controller_Phi_2DOF_N_2D_Lookup_Table;

SkywalkerX8.Control.Lateral.PhiController.KpPhi = squeeze(tableValues.PIDF_Controller_Phi_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.KiPhi = squeeze(tableValues.PIDF_Controller_Phi_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.KdPhi = squeeze(tableValues.PIDF_Controller_Phi_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.NPhi = squeeze(tableValues.PIDF_Controller_Phi_N_2D_Lookup_Table);

SkywalkerX8.Control.Lateral.PhiController.KpPhi2DOF = squeeze(tableValues.PDF_Controller_Phi_2DOF_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.KdPhi2DOF = squeeze(tableValues.PDF_Controller_Phi_2DOF_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.NPhi2DOF = squeeze(tableValues.PDF_Controller_Phi_2DOF_N_2D_Lookup_Table);
...
SkywalkerX8.Control.Lateral.PhiController.BasisFunction = TGS.PIDF_Controller_Phi_Kp_2D_Lookup_Table.BasisFunctions;
SkywalkerX8.Control.Lateral.PhiController.KpPhiParameterizedGains = getData(TGS.PIDF_Controller_Phi_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.KiPhiParameterizedGains = getData(TGS.PIDF_Controller_Phi_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.KdPhiParameterizedGains = getData(TGS.PIDF_Controller_Phi_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.NPhiParameterizedGains = getData(TGS.PIDF_Controller_Phi_N_2D_Lookup_Table);

SkywalkerX8.Control.Lateral.PhiController.KpPhi2DOFParameterizedGains = getData(TGS.PDF_Controller_Phi_2DOF_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.KdPhi2DOFParameterizedGains = getData(TGS.PDF_Controller_Phi_2DOF_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.PhiController.NPhi2DOFParameterizedGains = getData(TGS.PDF_Controller_Phi_2DOF_N_2D_Lookup_Table);
...
tunedBlocks = {'PIDF Controller Chi Kp 2D Lookup Table',...
               ...
               'PIDF Controller Chi Kd 2D Lookup Table',...
               'PIDF Controller Chi N 2D Lookup Table'};
...
POI = {'SkywalkerX8_Lateral_Control/Chi_c/1'
       'SkywalkerX8_Lateral_Control/Chi_e' 
       'SkywalkerX8_Lateral_Control/Phi_c'
       'SkywalkerX8_Lateral_Control/Sum2/Chi_e'
       'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/PIDF Controller Va_theta/POut'
       'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/PIDF Controller Va_theta/De*'
       'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/PIDF Controller Va_theta/NDe*'
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Va' 
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/p' 
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Phi'
       'SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Chi'};
...
ST0.addOpening('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Va');
ST0.addOpening('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/p');
ST0.addOpening('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Phi');
...
SkywalkerX8.Control.Lateral.ChiController.upperSaturationPhiC = phiMax;
SkywalkerX8.Control.Lateral.ChiController.lowerSaturationPhiC = -phiMax;

% so we can generate a
% limit on gain from these 2 values:

ChiPhiGainLimit = phiMax/chiMax;

% and we assume this will only really be commanded if we are in trim

ChiPhiPGainLimitInput = 'SkywalkerX8_Lateral_Control/Sum2/Chi_e';
ChiPhiPGainLimitOutput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/Phi_c';
...
R2 = TuningGoal.Margins('SkywalkerX8_Lateral_Control/SkywalkerX8 Aircraft + Aerodynamics Lateral/Chi', gainMargin, phaseMargin);
R2.Focus = [1E-02 1E02];
...
ChiPhiPGainLimitInput = 'SkywalkerX8_Lateral_Control/Sum2/Chi_e';
ChiPhiPGainLimitOutput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/PIDF Controller Va_theta/POut';

R5 = TuningGoal.Gain(ChiPhiPGainLimitInput, ChiPhiPGainLimitOutput, 2*ChiPhiGainLimit);
R5.Focus = [1E-02 1E02];
R5.Openings = {ChiPhiPGainLimitInput, ChiPhiPGainLimitOutput};

% Filter Gain Limit

% We constrain our filter to be as aggressive as possible 

NGainLimit = 1;

NGainLimitInput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/PIDF Controller Va_theta/Sum/De*';
NGainLimitOutput = 'SkywalkerX8_Lateral_Control/Gain Scheduled Controller Chi/PIDF Controller Va_theta/Product1/NDe*';
...
ST0.setBlockParam('PIDF Controller Chi Kd 2D Lookup Table', Kd);
ST0.setBlockParam('PIDF Controller Chi N 2D Lookup Table', N);

STChi = systune(ST0, [R1, R2, R6], [R3, R4, R5], sysTuneOpts);

tableValues = getBlockValue(STChi);

SkywalkerX8.Control.Lateral.ChiController.KpChiTF = tableValues.PIDF_Controller_Chi_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.ChiController.KiChiTF = tableValues.PIDF_Controller_Chi_Ki_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.ChiController.KdChiTF = tableValues.PIDF_Controller_Chi_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Lateral.ChiController.NChiTF = tableValues.PIDF_Controller_Chi_N_2D_Lookup_Table;

SkywalkerX8.Control.Lateral.ChiController.KpChi = squeeze(tableValues.PIDF_Controller_Chi_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.ChiController.KiChi = squeeze(tableValues.PIDF_Controller_Chi_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.ChiController.KdChi = squeeze(tableValues.PIDF_Controller_Chi_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.ChiController.NChi = squeeze(tableValues.PIDF_Controller_Chi_N_2D_Lookup_Table);

% Get scheduling parameters and write them to our desired variables
% Note thase these are based on our basis function.

TGS = getBlockParam(STChi);
SkywalkerX8.Control.Lateral.ChiController.BasisFunction = TGS.PIDF_Controller_Chi_Kp_2D_Lookup_Table.BasisFunctions;
SkywalkerX8.Control.Lateral.ChiController.KpChiParameterizedGains = getData(TGS.PIDF_Controller_Chi_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.ChiController.KiChiParameterizedGains = getData(TGS.PIDF_Controller_Chi_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.ChiController.KdChiParameterizedGains = getData(TGS.PIDF_Controller_Chi_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Lateral.ChiController.NChiParameterizedGains = getData(TGS.PIDF_Controller_Chi_N_2D_Lookup_Table);
