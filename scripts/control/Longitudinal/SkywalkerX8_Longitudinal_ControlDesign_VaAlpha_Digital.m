...
sys = 'SkywalkerX8_Longitudinal_Control_Digital';
...
SkywalkerX8.Control.Longitudinal.thetaController.Digital.SampleTime = 1/100;
SkywalkerX8.Control.Longitudinal.altController.Digital.SampleTime = 1/100;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.SampleTime = 1/100;

SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpTheta = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KiTheta = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdTheta = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NTheta = zeros(nVa, nalpha);

SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpTheta2DOF = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdTheta2DOF = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NTheta2DOF = zeros(nVa, nalpha);

SkywalkerX8.Control.Longitudinal.altController.Digital.KpAlt = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.altController.Digital.KiAlt = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.altController.Digital.KdAlt = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.altController.Digital.NAlt = zeros(nVa, nalpha);

SkywalkerX8.Control.Longitudinal.altController.Digital.KpAlt2DOF = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.altController.Digital.KdAlt2DOF = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.altController.Digital.NAlt2DOF = zeros(nVa, nalpha);

SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KpVaTheta = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KiVaTheta = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KdVaTheta = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.NVaTheta = zeros(nVa, nalpha);

SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KpVaTheta2DOF = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KdVaTheta2DOF = zeros(nVa, nalpha);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.NVaTheta2DOF = zeros(nVa, nalpha);

% Reset Saturation Limits %

SkywalkerX8.Control.Longitudinal.thetaController.Digital.upperSaturationNegativeDe = Inf;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.lowerSaturationNegativeDe = -Inf;

SkywalkerX8.Control.Longitudinal.altController.Digital.upperSaturationThetaC = Inf;
SkywalkerX8.Control.Longitudinal.altController.Digital.lowerSaturationThetaC = -Inf;

SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.upperSaturationThetaC = Inf;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.lowerSaturationThetaC = -Inf;
...
POI = {'SkywalkerX8_Longitudinal_Control_Digital/theta_c'
       'SkywalkerX8_Longitudinal_Control_Digital/theta_e' 
       'SkywalkerX8_Longitudinal_Control_Digital/de'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Sum/de*_e'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Product1/Nde*_e'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Integrator/de*'
       'SkywalkerX8_Longitudinal_Control_Digital/Switch/theta_c'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/de'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/PI Controller Theta/POut'
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/Va' 
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/h' 
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/theta'
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/alpha'
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/q'};

ST0.addPoint(POI);

ST0.addOpening('theta_c');
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/Va');
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/h');
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/alpha');
...
SkywalkerX8.Control.Longitudinal.thetaController.Digital.upperSaturationNegativeDe = deMax;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.lowerSaturationNegativeDe = -deMax;
...
thetaPGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Sum/theta_e';
thetaPGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/de';
...
NGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Sum/de*_e';
NGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Product1/Nde*_e';

NGainLimitLoopOpening = {'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Sum/de*_e',...
                         'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/DF Controller Theta/Product1/Nde*_e'};
...
R3 = TuningGoal.Margins('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/theta', gainMargin, phaseMargin);
...
thetac2DeGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Sum/theta_e';
thetac2DeGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Theta/PI Controller Theta/POut';
...
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpThetaTF = tableValues.PIDF_Controller_theta_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KiThetaTF = tableValues.PIDF_Controller_theta_Ki_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdThetaTF = tableValues.PIDF_Controller_theta_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NThetaTF = tableValues.PIDF_Controller_theta_N_2D_Lookup_Table;

SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpTheta2DOFTF = tableValues.PDF_Controller_theta_2DOF_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdTheta2DOFTF = tableValues.PDF_Controller_theta_2DOF_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NTheta2DOFTF = tableValues.PDF_Controller_theta_2DOF_N_2D_Lookup_Table;

SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpTheta = squeeze(tableValues.PIDF_Controller_theta_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KiTheta = squeeze(tableValues.PIDF_Controller_theta_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdTheta = squeeze(tableValues.PIDF_Controller_theta_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NTheta = squeeze(tableValues.PIDF_Controller_theta_N_2D_Lookup_Table);

SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpTheta2DOF = squeeze(tableValues.PDF_Controller_theta_2DOF_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdTheta2DOF = squeeze(tableValues.PDF_Controller_theta_2DOF_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NTheta2DOF = squeeze(tableValues.PDF_Controller_theta_2DOF_N_2D_Lookup_Table);
...
SkywalkerX8.Control.Longitudinal.thetaController.Digital.BasisFunction = TGS.PIDF_Controller_theta_Kp_2D_Lookup_Table.BasisFunctions;
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpThetaParameterizedGains = getData(TGS.PIDF_Controller_theta_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KiThetaParameterizedGains = getData(TGS.PIDF_Controller_theta_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdThetaParameterizedGains = getData(TGS.PIDF_Controller_theta_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NThetaParameterizedGains = getData(TGS.PIDF_Controller_theta_N_2D_Lookup_Table);

SkywalkerX8.Control.Longitudinal.thetaController.Digital.KpTheta2DOFParameterizedGains = getData(TGS.PDF_Controller_theta_2DOF_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.KdTheta2DOFParameterizedGains = getData(TGS.PDF_Controller_theta_2DOF_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.thetaController.Digital.NTheta2DOFParameterizedGains = getData(TGS.PDF_Controller_theta_2DOF_N_2D_Lookup_Table);
...
POI = {'SkywalkerX8_Longitudinal_Control_Digital/h_c'
       'SkywalkerX8_Longitudinal_Control_Digital/h_e' 
       'SkywalkerX8_Longitudinal_Control_Digital/theta_c_h'
       'SkywalkerX8_Longitudinal_Control_Digital/de'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/Sum/theta_c*_e'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/Product1/theta_c*'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/POut'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/IOut/1'
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/Va' 
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/h' 
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/theta'
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/alpha'
...
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/Va');
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/theta');
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/alpha');
ST0.addOpening('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/q');
...
SkywalkerX8.Control.Longitudinal.altController.Digital.upperSaturationThetaC = thetaMax;
SkywalkerX8.Control.Longitudinal.altController.Digital.lowerSaturationThetaC = -thetaMax;
...
altPGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Sum2/h_e';
altPGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/POut';
...
R2 = TuningGoal.Margins('SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/h', gainMargin, phaseMargin);
R2.Focus = [1E-02 1E02];
...
altFFControllerPGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/h_c';
altFFControllerPGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/theta_c_h';

R5 = TuningGoal.Gain(altFFControllerPGainLimitInput, altFFControllerPGainLimitOutput, altGainLimit);
R5.Openings = 'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/h';
R5.Focus = [1E-02 1E02];
...
NGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/Sum/theta_c*_e';
NGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/Product1/theta_c*';

NGainLimitLoopOpening = {'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/Sum/theta_c*_e',...
                         'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller h_theta/PIDF Controller h_theta/Product1/theta_c*'};
...
SkywalkerX8.Control.Longitudinal.altController.Digital.KpAltTF = tableValues.PIDF_Controller_h_theta_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.altController.Digital.KiAltTF = tableValues.PIDF_Controller_h_theta_Ki_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.altController.Digital.KdAltTF = tableValues.PIDF_Controller_h_theta_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.altController.Digital.NAltTF = tableValues.PIDF_Controller_h_theta_N_2D_Lookup_Table;

SkywalkerX8.Control.Longitudinal.altController.Digital.KpAlt = squeeze(tableValues.PIDF_Controller_h_theta_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.altController.Digital.KiAlt = squeeze(tableValues.PIDF_Controller_h_theta_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.altController.Digital.KdAlt = squeeze(tableValues.PIDF_Controller_h_theta_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.altController.Digital.NAlt = squeeze(tableValues.PIDF_Controller_h_theta_N_2D_Lookup_Table);

% Get scheduling parameters and write them to our desired variables
% Note thase these are based on our basis function.

TGS = getBlockParam(STAlt);
SkywalkerX8.Control.Longitudinal.altController.Digital.BasisFunction = TGS.PIDF_Controller_h_theta_Kp_2D_Lookup_Table.BasisFunctions;
SkywalkerX8.Control.Longitudinal.altController.Digital.KpAltParameterizedGains = getData(TGS.PIDF_Controller_h_theta_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.altController.Digital.KiAltParameterizedGains = getData(TGS.PIDF_Controller_h_theta_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.altController.Digital.KdAltParameterizedGains = getData(TGS.PIDF_Controller_h_theta_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.altController.Digital.NAltParameterizedGains = getData(TGS.PIDF_Controller_h_theta_N_2D_Lookup_Table);
...
SkywalkerX8.Control.Longitudinal.altController.Digital.KtScalar = 10;
...
POI = {'SkywalkerX8_Longitudinal_Control_Digital/Va_c'
       'SkywalkerX8_Longitudinal_Control_Digital/Va_e' 
       'SkywalkerX8_Longitudinal_Control_Digital/theta_c_Va'
       'SkywalkerX8_Longitudinal_Control_Digital/de'
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/Va' 
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/h' 
       'SkywalkerX8_Longitudinal_Control_Digital/SkywalkerX8 Aircraft + Aerodynamics Longitudinal/theta'
...
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.upperSaturationThetaC = thetaMax;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.lowerSaturationThetaC = -thetaMax;
...
VaThetaPGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Sum3/Va_e';
VaThetaPGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Va_theta/theta_c_Va';
...
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KpVaThetaTF = tableValues.PIDF_Controller_Va_theta_Kp_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KiVaThetaTF = tableValues.PIDF_Controller_Va_theta_Ki_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KdVaThetaTF = tableValues.PIDF_Controller_Va_theta_Kd_2D_Lookup_Table;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.NVaThetaTF = tableValues.PIDF_Controller_Va_theta_N_2D_Lookup_Table;

SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KpVaTheta = squeeze(tableValues.PIDF_Controller_Va_theta_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KiVaTheta = squeeze(tableValues.PIDF_Controller_Va_theta_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KdVaTheta = squeeze(tableValues.PIDF_Controller_Va_theta_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.NVaTheta = squeeze(tableValues.PIDF_Controller_Va_theta_N_2D_Lookup_Table);

% Get scheduling parameters and write them to our desired variables
% Note thase these are based on our basis function.

TGS = getBlockParam(STVaTheta);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.BasisFunction = TGS.PIDF_Controller_Va_theta_Kp_2D_Lookup_Table.BasisFunctions;
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KpVaThetaParameterizedGains = getData(TGS.PIDF_Controller_Va_theta_Kp_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KiVaThetaParameterizedGains = getData(TGS.PIDF_Controller_Va_theta_Ki_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KdVaThetaParameterizedGains = getData(TGS.PIDF_Controller_Va_theta_Kd_2D_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.NVaThetaParameterizedGains = getData(TGS.PIDF_Controller_Va_theta_N_2D_Lookup_Table);
...
SkywalkerX8.Control.Longitudinal.VaThetaController.Digital.KtScalar = 10;
