...
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.SampleTime = 1/100;

SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KpVaDt = zeros(nVa, 1);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KiVaDt = zeros(nVa, 1);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KdVaDt = zeros(nVa, 1);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.NVaDt = zeros(nVa, 1);

SkywalkerX8.Control.Longitudinal.VaDtController.Digital.upperSaturationDt = Inf;
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.lowerSaturationDt = -Inf;
...
POI = {'SkywalkerX8_Longitudinal_Control_Digital/Va_c'
       ...
       'SkywalkerX8_Longitudinal_Control_Digital/dt'
       ...
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Va_dt/PIDF Controller Va_dt/Sum/De'
       'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Va_dt/PIDF Controller Va_dt/Product1/NDe'};
...
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.upperSaturationDt = dtMax;
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.lowerSaturationDt = 0;
...
VaDtPGainLimitInput = 'SkywalkerX8_Longitudinal_Control_Digital/Sum3/Va_e';
VaDtPGainLimitOutput = 'SkywalkerX8_Longitudinal_Control_Digital/Gain Scheduled Controller Va_dt/dt';
...
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KpVaDtTF = tableValues.PIDF_Controller_Va_dt_Kp_Lookup_Table;
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KiVaDtTF = tableValues.PIDF_Controller_Va_dt_Ki_Lookup_Table;
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KdVaDtTF = tableValues.PIDF_Controller_Va_dt_Kd_Lookup_Table;
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.NVaDtTF = tableValues.PIDF_Controller_Va_dt_N_Lookup_Table;

SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KpVaDt = squeeze(tableValues.PIDF_Controller_Va_dt_Kp_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KiVaDt = squeeze(tableValues.PIDF_Controller_Va_dt_Ki_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KdVaDt = squeeze(tableValues.PIDF_Controller_Va_dt_Kd_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.NVaDt = squeeze(tableValues.PIDF_Controller_Va_dt_N_Lookup_Table);
...
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.BasisFunction = TGS.PIDF_Controller_Va_dt_Kp_Lookup_Table.BasisFunctions;
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KpVaDtParameterizedGains = getData(TGS.PIDF_Controller_Va_dt_Kp_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KiVaDtParameterizedGains = getData(TGS.PIDF_Controller_Va_dt_Ki_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KdVaDtParameterizedGains = getData(TGS.PIDF_Controller_Va_dt_Kd_Lookup_Table);
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.NVaDtParameterizedGains = getData(TGS.PIDF_Controller_Va_dt_N_Lookup_Table);
...
SkywalkerX8.Control.Longitudinal.VaDtController.Digital.KtScalar = 10;
