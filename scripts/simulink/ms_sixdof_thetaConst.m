...
function InitConditions(block)
    ...
    if (sqrt(block.DialogPrm(2).Data(1)^2 + block.DialogPrm(2).Data(2)^2 + block.DialogPrm(2).Data(3)^2) ~= 0)
    ...
    block.Dwork(2).Data(8) = 0; %Hold theta constant
...
function Derivatives(block)
    ...
    block.Derivatives.Data(8) = 0; %Hold theta constant (ie. q = 0)
