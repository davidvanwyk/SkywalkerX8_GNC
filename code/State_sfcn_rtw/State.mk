###########################################################################
## Makefile generated for Simulink model 'State'. 
## 
## Makefile     : State.mk
## Generated on : Tue Sep 24 11:29:17 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/State_sf.mexw64
...
MODELREF_LINK_RSPFILE_NAME = State_ref.rsp
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/State_sfcn_rtw -IC:/MATLAB/masters/models/Guidance -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include
...
DEFINES_STANDARD = -DMODEL=State -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/State_sfcn_rtw/State_sf_data.c $(START_DIR)/State_sfcn_rtw/rtGetInf.c $(START_DIR)/State_sfcn_rtw/rtGetNaN.c
...
OBJS = State_sf_data.obj rtGetInf.obj rtGetNaN.obj
...
%.obj : $(START_DIR)/State_sfcn_rtw/%.c
	$(MEX) $(MEX_OPTS_FLAG) -c $(MEX_CFLAGS) -outdir "$(dir $@)" "$<"


%.obj : $(START_DIR)/State_sfcn_rtw/%.cpp
	$(MEX) $(MEX_CPP_OPTS_FLAG) -c $(MEX_CPPFLAGS) -outdir "$(dir $@)" "$<"
