...
## Generated on : Tue Sep 24 11:28:02 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Autopilot_sf.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Autopilot_sf.mexw64
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Autopilot_sfcn_rtw -IC:/MATLAB/masters/models/Guidance -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src
...
SRCS = $(START_DIR)/Autopilot_sfcn_rtw/Autopilot_sf_data.c $(START_DIR)/Autopilot_sfcn_rtw/rtGetInf.c $(START_DIR)/Autopilot_sfcn_rtw/rtGetNaN.c
...
OBJS = Autopilot_sf_data.obj rtGetInf.obj rtGetNaN.obj
...
%.obj : $(START_DIR)/Autopilot_sfcn_rtw/%.c
	$(MEX) $(MEX_OPTS_FLAG) -c $(MEX_CFLAGS) -outdir "$(dir $@)" "$<"


%.obj : $(START_DIR)/Autopilot_sfcn_rtw/%.cpp
	$(MEX) $(MEX_CPP_OPTS_FLAG) -c $(MEX_CPPFLAGS) -outdir "$(dir $@)" "$<"
